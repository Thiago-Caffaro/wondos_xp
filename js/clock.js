...
$("#lixeira").dblclick(function () {
  ...
  $("#cmdIframe").css("display", "none");
  $(".icon-lixo").css("display", "block");

  $(".topIcon").attr("src", "https://www.clipartmax.com/png/full/92-925325_modernxp-76-trash-full-icon-windows-xp-recycle-bin-icon-png.png");
  $(".topTitle").text("Lixeira");
...
//DUPLO CLIQUE NO ÍCONE NO CMD
$("#cmd").dblclick(function () {
  $("#cmd").removeClass("selected");
  $("#cmd").addClass("selected");
  $(".janela").css("display", "flex");

  $(".icon-lixo").css("display", "none");
  $("#cmdIframe").css("display", "block");

  $(".topIcon").attr("src", "assets/images/icons/cmd.png");
  $(".topTitle").text("CMD");
  $(".prog").addClass("active");
  $(".prog").css("display", "flex");
});
